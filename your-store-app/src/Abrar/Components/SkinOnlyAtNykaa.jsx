...
export default function SkinOnlyAtNykaa ( ) {
    ...
    return (
        <>
         <Text textAlign='center' fontSize={{base : '16px', md : '24px', lg : '26px'}} fontWeight='650' letterSpacing={{base  : '2px'}} mt={{base : '20px', md : '30px', lg: '7%'}}>ONLY AT SHOPPING PARADISE</Text>
