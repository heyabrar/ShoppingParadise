    ...
    return (
        ...
        <Box bg='#2D3748' color='white' padding='20px' mt='10px' fontWeight='550' >
            <SimpleGrid columns={[1,2,3,3]} w={{base : '95%', md: '100%'}} m='auto' rowGap={'10px'}>
                ...
                <Box fontSize={{base : '12px', lg : '15px'}} textAlign='center'>
                    <Flex alignItems='center'  justifyContent='center' gap='10px'>
                        <BsFillTelephoneFill/>
        ...
        <Box padding={{base : '10px' ,lg : '60px'}}>
            <SimpleGrid columns={[3,3,3,5]} w={{base : '95%', lg : '85%'}} m='auto' fontSize={{base : '10px', md : '12px'}} rowGap='20px' display={{base: 'none', md :'grid'}}>
