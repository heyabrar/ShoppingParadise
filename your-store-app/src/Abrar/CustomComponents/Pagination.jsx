...
export default function Pagination ({current,onChange,totalPage,limit}){    
    return (
       ...
       <Button onClick={( ) => onChange(current+1)} disabled={current === Math.ceil(totalPage/limit)}  bg='#fc2779' size={{base : 'sm', md : 'md'}} color='white' colorScheme='#fc2779'><GrNext/></Button>
        </Flex>
        </>
    )
}